...
const SquareMeterSquareFeetConverter: React.FC = () => {
  ...
  const convert = () => {
    ...
    const valueInSquareMeter = valueNum * conversionFactors[fromUnit];
    const convertedValue = valueInSquareMeter / conversionFactors[toUnit];
  ...
  return (
    <div className="max-w-md mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Square Meter to Square Feet Converter</h2>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-xs text-blue-800">
            ...
            1 Square Foot = 0.093 Square Meters<br/>
...
export default SquareMeterSquareFeetConverter;
